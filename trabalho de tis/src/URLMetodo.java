...
public class URLMetodo implements Container {
	...
	static usuarioservece estoqueService;
	...
	public void handle(Request request, Response response) {
		try {
			...
			/*if (path.startsWith("/adicionarProduto") && "POST".equals(method)) {
				...
				mensagem = estoqueService.remover(request);
				if (mensagem == null)
	...
	public static void main(String[] list) throws Exception {
		...
		estoqueService = new usuarioservece();
